...
/* harmony import */ var _modules_nav_burger__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/nav-burger */ "./js/modules/nav-burger.js");
...
/* harmony import */ var _modules_init_slider_table__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/init-slider-table */ "./js/modules/init-slider-table.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_nav_burger__WEBPACK_IMPORTED_MODULE_3__["initBurgerNav"])(); // все скрипты должны быть в обработчике 'DOMContentLoaded', но не все в 'load'
  ...
  window.addEventListener('load', function () {
    ...
    Object(_modules_init_slider__WEBPACK_IMPORTED_MODULE_4__["initSlider"])();
    Object(_modules_init_slider_table__WEBPACK_IMPORTED_MODULE_5__["initSliderTable"])();
  });
}); // ---------------------------------
...
var validateWebsiteInput = function validateWebsiteInput(input) {
  var parent = input.closest('[data-validate-type]');
  var flag = true;
  var websiteString = /[-a-zA-Z0-9@:%._\+~#=]{1,256}\.[a-zA-Z0-9()]{1,6}\b([-a-zA-Z0-9()@:%_\+.~#?&//=]*)/;
  var regWebsite = new RegExp(websiteString, '');

  if (regWebsite.test(input.value)) {
    parent.classList.remove('is-invalid');
    parent.classList.add('is-valid');
    input.setAttribute('aria-invalid', 'false');
  } else {
...
var validateInputs = function validateInputs(type, input) {
  switch (type) {
    ...
    case 'website':
      return validateWebsiteInput(input);
...
var formElementValidateAction = function formElementValidateAction(formValidateElement) {
  ...
  if (dataValidateType !== 'toggle-group') {
    var formElement = formValidateElement.querySelector('input');
    var formElementTelegram = formValidateElement.querySelector('input[name=user-telegram]');
...
var activeButton = function activeButton(form) {
  var formElementsWrapper = form.querySelectorAll('[data-validate-type]');
  var formButton = form.querySelector('.form__btn');
  var arrIsValid = [];

  var _loop = function _loop(i) {
    if (formElementsWrapper[i].closest('[data-not-required]')) {
      var inputNotRequired = formElementsWrapper[i].querySelector('input');

      if (inputNotRequired.value === '') {
        setTimeout(function () {
          formElementsWrapper[i].classList.remove('is-invalid');
        }, 100);
        arrIsValid.push(true);
      } else if (formElementsWrapper[i].classList.contains('is-valid')) {
        arrIsValid.push(true);
      } else if (formElementsWrapper[i].classList.contains('is-invalid')) {
        arrIsValid.push(false);
      }
    } else {
      if (!formElementsWrapper[i].closest('.is-valid')) {
        arrIsValid.push(false);
      } else {
        arrIsValid.push(true);
      }
  ...
  for (var i = 0; i < formElementsWrapper.length; i++) {
    _loop(i);
  }

  var isInValid = arrIsValid.includes(false);
...
window.clearForm = clearForm; // Событие изменения поля
...
var inputChange = function inputChange(el) {
  ...
  if (input) {
    var typeInput = el.dataset.validateType;
    var isValidInput = validateInputs(typeInput, input);
  ...
  if (textarea) {
    var isValidText = validateTextInput(textarea);
      ...
      if (formValidateElements.length) {
        formValidateElements.forEach(function (el) {
          ...
          el.addEventListener('focusout', function () {
            if (!el.closest('[data-not-required]')) {
              inputChange(el);
            }
          });
        });
...
/***/ "./js/modules/init-slider-table.js":
/*!*****************************************!*\
  !*** ./js/modules/init-slider-table.js ***!
  \*****************************************/
/*! exports provided: initSliderTable */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initSliderTable", function() { return initSliderTable; });
var initSliderTable = function initSliderTable() {
  var sliderBlock = document.querySelector('.conditions');
  ...
  var btn = sliderBlock.querySelectorAll('.table__btn');
  var swiper;
      ...
      swiper.on('slideChange', function () {
        btn.forEach(function (element, index) {
          if (swiper.activeIndex === index) {
            element.classList.add('table__btn--curent');
          } else {
            element.classList.remove('table__btn--curent');
          }
        });
      });
    }
...
var initSlider = function initSlider() {
  var sliderBlock = document.querySelector('.cases');
  ...
  var slider = sliderBlock.querySelector('.swiper');
  var pagination = sliderBlock.querySelector('.swiper-pagination');
  var breakpoint = window.matchMedia('(min-width:768px)');
  var swiper;
...
/***/ "./js/modules/nav-burger.js":
/*!**********************************!*\
  !*** ./js/modules/nav-burger.js ***!
  \**********************************/
/*! exports provided: initBurgerNav */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initBurgerNav", function() { return initBurgerNav; });
...
var overlayNav = document.querySelector('.main-nav__overlay');
var toggleNav = document.querySelector('.main-nav__toggle');
var btnLightNav = document.querySelector('.btn--light.btn--main-nav');
var anchors = document.querySelectorAll('.main-nav__link');
var scrollLock = new _utils_scroll_lock__WEBPACK_IMPORTED_MODULE_0__["ScrollLock"]();

var closesNav = function closesNav() {
  scrollLock.enableScrolling();
  mainNav.classList.remove('main-nav--open');
};

var closesBurgerMenu = function closesBurgerMenu(element) {
  if (element) {
    element.addEventListener('click', function () {
      var blockID = element.getAttribute('href').substring(1);
...
var initBurgerNav = function initBurgerNav() {
  ...
  if (overlayNav) {
    overlayNav.addEventListener('click', function (evt) {
      if (mainNav.classList.contains('main-nav--open')) {
        evt.preventDefault();
        closesNav();
      }
