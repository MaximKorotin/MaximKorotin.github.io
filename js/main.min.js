...
/* harmony import */ var _modules_slider_promo_slider__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/slider/promo-slider */ "./js/modules/slider/promo-slider.js");
/* harmony import */ var _modules_catalog_filter__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/catalog-filter */ "./js/modules/catalog-filter.js");
/* harmony import */ var _modules_slider_geography_slider__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/slider/geography-slider */ "./js/modules/slider/geography-slider.js");
/* harmony import */ var _modules_slider_product_slider__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/slider/product-slider */ "./js/modules/slider/product-slider.js");
/* harmony import */ var _modules_tabs_init_tabs__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/tabs/init-tabs */ "./js/modules/tabs/init-tabs.js");
/* harmony import */ var _modules_range__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/range */ "./js/modules/range.js");
/* harmony import */ var _modules_active_icons__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/active-icons */ "./js/modules/active-icons.js");
/* harmony import */ var _modules_navigation_main_nav__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modules/navigation/main-nav */ "./js/modules/navigation/main-nav.js");
/* harmony import */ var _modules_calc_rent__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./modules/calc-rent */ "./js/modules/calc-rent.js");
/* harmony import */ var _modules_sticky__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./modules/sticky */ "./js/modules/sticky.js");
/* harmony import */ var _modules_navigation_mobile_menu__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./modules/navigation/mobile-menu */ "./js/modules/navigation/mobile-menu.js");
/* harmony import */ var _modules_filter_bar__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./modules/filter-bar */ "./js/modules/filter-bar.js");
/* harmony import */ var _modules_scroll_sequence__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./modules/scroll-sequence */ "./js/modules/scroll-sequence.js");
/* harmony import */ var _modules_init_accordion__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./modules/init-accordion */ "./js/modules/init-accordion.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_slider_promo_slider__WEBPACK_IMPORTED_MODULE_3__["initPromoSlider"])();
  Object(_modules_slider_geography_slider__WEBPACK_IMPORTED_MODULE_5__["initGeographySlider"])();
  Object(_modules_tabs_init_tabs__WEBPACK_IMPORTED_MODULE_7__["initTabs"])();
  Object(_modules_navigation_main_nav__WEBPACK_IMPORTED_MODULE_10__["initNavToggle"])();
  Object(_modules_navigation_mobile_menu__WEBPACK_IMPORTED_MODULE_13__["initMobileMenu"])();
  Object(_modules_slider_product_slider__WEBPACK_IMPORTED_MODULE_6__["initProductSlider"])();
  Object(_modules_init_accordion__WEBPACK_IMPORTED_MODULE_16__["initAccordions"])(); // все скрипты должны быть в обработчике 'DOMContentLoaded', но не все в 'load'
  ...
  window.addEventListener('load', function () {
    ...
    Object(_modules_catalog_filter__WEBPACK_IMPORTED_MODULE_4__["initCatalogFilter"])();
    Object(_modules_range__WEBPACK_IMPORTED_MODULE_8__["initRange"])();
    Object(_modules_active_icons__WEBPACK_IMPORTED_MODULE_9__["initActiveIcons"])();
    Object(_modules_calc_rent__WEBPACK_IMPORTED_MODULE_11__["initCalcRent"])();
    Object(_modules_sticky__WEBPACK_IMPORTED_MODULE_12__["initSticky"])();
    Object(_modules_filter_bar__WEBPACK_IMPORTED_MODULE_14__["initFilterBar"])();
    Object(_modules_scroll_sequence__WEBPACK_IMPORTED_MODULE_15__["initScrollSequence"])();
  });
}); // ---------------------------------
...
var initCatalogFilter = function initCatalogFilter() {
  ...
  var filters = body.querySelectorAll('.filters-item__wrapper');
  ...
  if (filters) {
    var formFilters = body.querySelector('.form-filters__list');
    ...
    filters.forEach(function (item) {
      item.addEventListener('click', function (evt) {
        ...
        var filtersCostList = parent.querySelector('.cost-list');

        var keepsTrackResizing = function keepsTrackResizing() {
          var rightIndentList = formFilters.getBoundingClientRect().right - 2;
          var rightIndentItem = Math.round(parent.getBoundingClientRect().right);
          var topIndentList = formFilters.getBoundingClientRect().bottom;
          var topIndentItem = parent.getBoundingClientRect().bottom;
          var heightIndentItem = parent.offsetHeight;
          var topIndentFilter = topIndentList - topIndentItem;
          filtersList.style.top = topIndentFilter + heightIndentItem + 'px';
          brandsList.style.top = topIndentFilter + heightIndentItem + 2 + 'px';
          ...
          if (filtersCostList) {
            var rightIndentFilter = filtersCostList.getBoundingClientRect().right;

            if (rightIndentList === rightIndentItem && rightIndentFilter > rightIndentItem) {
              filtersCostList.style.left = 'auto';
              filtersCostList.style.right = 0;
            } else if (rightIndentList > rightIndentItem && rightIndentFilter <= rightIndentItem) {
              filtersCostList.style.right = 'auto';
              filtersCostList.style.left = 0;
            }
          }
        };
...
var initFilterBar = function initFilterBar() {
  ...
  if (filters) {
    ...
    var filtersList = filters.querySelector('.filters__wrapper');
    var buttonFilters = filters.querySelector('.filters__toggle');
    var filtersItem = filters.querySelectorAll('.filters-item');

    if (buttonFilters) {
      buttonFilters.addEventListener('click', function () {
        if (buttonFilters.classList.contains('filters__toggle--active')) {
          buttonFilters.classList.remove('filters__toggle--active');
          filtersList.classList.remove('filters__wrapper--active');
          overlay.classList.remove('overlay--active');
          body.classList.remove('page-body--filter');
        } else if (!buttonFilters.classList.contains('filters__toggle--active')) {
          buttonFilters.classList.add('filters__toggle--active');
          filtersList.classList.add('filters__wrapper--active');
          filtersItem.forEach(function (item) {
            if (item.classList.contains('filters__item--active')) {
              overlay.classList.add('overlay--active');
              body.classList.add('page-body--filter');
            }
          });
