...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    _modules_slider_swiper__WEBPACK_IMPORTED_MODULE_4__["swiper"].on();
  });
}); // ---------------------------------
...
var btnSn = document.querySelector('.table__btn--sn');
var btnDn = document.querySelector('.table__btn--dn');
var btnDng = document.querySelector('.table__btn--dng');
...
if (btnSn) {
  btnSn.addEventListener('click', function (evt) {
    evt.preventDefault();
    swiper.slideTo(0, 0);
    btnSn.classList.add('table__btn--curent');
    btnDn.classList.remove('table__btn--curent');
    btnDng.classList.remove('table__btn--curent');
  });
}

if (btnDn) {
  btnDn.addEventListener('click', function (evt) {
    evt.preventDefault();
    swiper.slideTo(1, 0);
    btnSn.classList.remove('table__btn--curent');
    btnDn.classList.add('table__btn--curent');
    btnDng.classList.remove('table__btn--curent');
  });
}

if (btnDng) {
  btnDng.addEventListener('click', function (evt) {
    evt.preventDefault();
    swiper.slideTo(2, 0);
    btnSn.classList.remove('table__btn--curent');
    btnDn.classList.remove('table__btn--curent');
    btnDng.classList.add('table__btn--curent');
  });
}
